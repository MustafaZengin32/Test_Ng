...
public class ExcelUtils {
    ...
    //    Constructor : (bu sınıftan obje oluşturmak ya da hazir istedigimiz seyleri ilk basta yapmak istedigimiz icin kullanılır)
    //                   burda--->Excel path i ve içindeki sayfaya ulasmak icn kullinir
    public ExcelUtils(String path, String sheetName) {
        ...
        try {
            ...
            //-->workSheet dolu ise gecek, değilse mesajı verecek
